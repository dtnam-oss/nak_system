...
const SELF_HOSTED_POSTGRES_URL = process.env.POSTGRES_URL || 'postgresql://postgres:123@163.223.12.189:5432/nak_vn';
...
console.log('  - Database URL source:', process.env.POSTGRES_URL ? 'ENV VAR' : 'HARDCODED FALLBACK');
